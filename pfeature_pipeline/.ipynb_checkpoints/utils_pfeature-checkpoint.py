...
def preprocess_csv(csv_file):
    """
    Function to preprocess a csv file for pfeature feature calculation.
    ...
    # Replace -1 labels with 0 for consistency with ESM2 pipelines
    preprocessed_df['Class'] = preprocessed_df['Class'].replace(-1, 0)

    return preprocessed_df

def featurizer(preprocessed_dataframe, features):
