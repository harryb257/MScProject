...
from utils_pfeature import (select_datasets, preprocess_csv, class_weighting_for_clf,
...
def pipeline_pfeature(
    ...
    local_output = Path('./output') / pathogen_name / 'Pfeature'
    ...
    final_clf_trained = train_final_classifier(clf, lower_train_all, loss_fcn, epochs=best_auc_epochs)
