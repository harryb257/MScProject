...
from utils_pfeature import (load_esm_model_classification, select_datasets, preprocess_csv,
...
def esm2_pipeline(files,
    ...
    local_output = Path('./HB/output') / pathogen_name / f'pfeature'
