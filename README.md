...
### Project Overview
Pipeline scripts. This repository contains pipelines for:
...
Results
- Results for fine-tuned and non-fine-tuned models or engineered-feature representations across different pathogen datasets.

utilities_analysis
- Supporting Python scripts and jupyter notebooks for data analysis and figure generation.

requirements_envs_versions
- Supporting Conda and Python environments, dependancies and versions.

residue_label_alignment_verification
- Output files for preprocessing alignment verification.
